package co.com.binariasystems.mastercentral.web.view;
...
import co.com.binariasystems.mastercentral.web.controller.DashboardViewController;
...
public class DashboardView extends AbstractView implements MatCentralWebConstants {
	public static final String		MESSAGES_BUNDLE = MESSAGES_PACKAGE + "." + MAIN_MESSAGES_FILE;
	...
	public void init(){
		...
		treeMenu.setTitle(MatCentralBusinessUtils.getApplicationName());
	}
